...
if(isset($_POST['add2']))
{
	...
	$stmt=$admin->cud("INSERT INTO `acust` (`sid`,`cname`,`cadd`,`cphone`,`cemail`,`age`,`adhar`,`acno`,`acid`,`doo`,`image`) VALUES('$sid','$name','$address','$phone','$email','$age','$adhar','$acno','$act','$doj','$imagename')","saved");
